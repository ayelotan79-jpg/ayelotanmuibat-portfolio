(function () {
  ...
  // No backend on a static site, so submissions go straight to Web3Forms,
  // which emails the access key's owner directly — works for every
  // visitor regardless of whether they have a mail app configured.
